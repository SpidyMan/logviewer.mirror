...
//
// Copyright (c) 2001 - $Date: 2021/04/01 $ Seagate Technology, LLC.
//
...
*                 $Revision: #174 $
*                 $Change: 2154414 $
*                 $Author: david.a.thorsvik $
*                 $DateTime: 2021/04/01 11:15:01 $
*
*******************************************************************************/
/*******************************************************************************
*
...
#define MSG__MALLOC_FAILED                    150  /* Attempt to Malloc data failed */
#define MSG__LASER_ENABLED                    151  /* LASER Enabled */
#define MSG__LASER_DISABLED                   152  /* LASER Disabled */
#define MSG__LASER_ALREADY_ENABLED            153  /* LASER was found enabled prior to the command to enable LASER */
#define MSG__LASER_ALREADY_DISABLED           154  /* LASER was found disabled prior to the command to disable LASER */
#define MSG__STRRO_IMPROVED                   155  /* XCorr condition met strro improved, using new coeffs */
#define MSG__STRRO_WORSENED                   156  /* XCorr condition met strro worsened, retaining default coeffs */
#define MSG__SAP_SAVED_IN_ZAP                 157  /* SAP updated at conclusion of ZAP */
#define MSG__OPTIMAL_STRRO                    158  /* Max iterations reached selecting optimal iteration. */
#define MSG__USER_CTRLR_RANGE_BAD             159  /* User specified servo trk follow ctrlr too large.*/
#define MSG__SERVO_FLAW_SCAN_UNSUPPORTED      160  /* User requested servo flaw scan is unsupported.*/
#define MSG__116F_NOT_SUPPORTED_QADN          161  /* QADN - 116F not supported */
#define MSG__ADN_NOT_SUPPORTED_BY_116F        162  /* QADN - ADN not supported by 116F */
#define MSG__116F_NOT_SUPPORTED_QAVN          163  /* QAVN - 116F not supported */
#define MSG__AVN_NOT_SUPPORTED_BY_116F        164  /* QAVN - AVN not supported by 116F */
#define MSG__116F_NOT_SUPPORTED_QACF          165  /* QACF - 116F not supported */
#define MSG__ACF_NOT_SUPPORTED_BY_116F        166  /* QACF - ACF not supported by 116F */
#define MSG__116F_NOT_SUPPORTED_QCWOC         167  /* QCWOC - 116F not supported */
#define MSG__CWOC_NOT_SUPPORTED_BY_116F       168  /* QCWOC - CWOC not supported by 116F */
#define MSG__116F_NOT_SUPPORTED_QTWOC         169  /* QTWOC - 116F not supported */
#define MSG__TWOC_NOT_SUPPORTED_BY_116F       170  /* QTWOC - TWOC not supported by 116F */
#define MSG__INCORRECT_CWOC_TWOC_STATE_DI     171  /* DI - Incorrect CWOC / TWOC State.  NTZ needs both subsystems disabled */
#define MSG__INCORRECT_CWOC_TWOC_STATE_CPOS   172  /* CPOS - Incorrect CWOC / TWOC State.  NTZ needs both subsystems disabled */
#define MSG__MISSED_FASTIO_SAMPLES_DI         173  /* DI failed for MISSED_FASTIO_SAMPLES */
#define MSG__MISSED_FASTIO_SAMPLES_CPOS       174  /* CPOS failed for MISSED_FASTIO_SAMPLES */
#define MSG__TIME_IN_HANDLE_FAST_IO_SAMPLE    175  /* Time in HandleFastIOSample: */
#define MSG__FLEX_IO_STATUS                   176  /* FlexIOStatus: */
#define MSG__OVERRIDE_STORED_XFR              177  /* The override bit was set.  Xfr Funcs will be remeasured. */
#define MSG__USING_SAVED_SPT_XFR_FUNCS        178  /* All saved SPT Xfr Func files are present and will be used to ZAP. */
#define MSG__PARMS_CONFLICT_W_SPT_XFR_STORE   179  /* User parms conflict with presence of SPT Xfr func files, Remeasure suppressed. */
#define MSG__XFR_FUNC_FROM_PC_FILE            180  /* User parms directed retrieval of XFR func from PC file. */
#define MSG__XFR_FUNC_MEASURE                 181  /* User parms directed measurement of Xfr func.  It will be measured. */
#define MSG__XFR_USER_PROVIDED_NO_INPUT       182  /* User provided no input regarding transfer function source. A source will be selected. */
#define MSG__GET_AND_SET_XFR_BOTH_SET         183  /* Can't have both set and read xfr func set together. */
#define MSG__T440_DEBUG_NTZMAIN_PREP          184  /* Calling NTZPrep in NTZMain */
#define MSG__T440_GETPARM_START_HARM          185  /* NTZTestParms error: StartHarmonic must be greater than 0 */
#define MSG__T440_DEBUG_NTZMAIN_NTZSDS        186  /* Calling NTZSDS in NTZMain */
#define MSG__T440_DEBUG_NTZMAIN_TTRTM         187  /* Calling TTRTM in NTZMain */
#define MSG__T440_DEBUG_NTZMAIN_NTZRDS        188  /* Calling NTZRDS in NTZMain */
#define MSG__T440_NTZMAIN_VIR_AUDITS_SKIP     189  /* Virtual audits skipped due to input parameter choices */
#define MSG__T440_GDSWI_DI_FAILED             190  /* DI in GDSWI, failed */
#define MSG__T440_DGI_DGS_FAILED              191  /* DGS in DGI failed after all retries */
#define MSG__T440_DGI_SEEK_FAILED_ACFF        192  /* Seek in DGI failed while re-enabling ACFF adaption */
#define MSG__T440_DCC_DGS_FAILED              193  /* DGS in DCC failed after all retries */
#define MSG__T440_DCC_SEEK_FAILED_ACFF        194  /* Seek in DCC failed while re-enabling ACFF adaption */
#define MSG__T440_REAL_AUDIT_FAILED           195  /* NTZ failed: real mode Post-RRO is worse than Pre-RRO */
#define MSG__T440_VIRTUAL_AUDIT_FAILED        196  /* NTZ failed: virtual mode Post-RRO is worse than Pre-RRO */
#define MSG__T440_CNTZR_SEEK_FAILED           197  /* Cross-track NTZ recovery analysis: Failed a seek! */
#define MSG__T440_DNTZ_WRITE_INIT_FAILED      198  /* Reason: ZAP_WRITE_ERROR_INIT_FAILED */
#define MSG__T440_DNTZ_WRITE_SEC_MISMATCH     199  /* Reason: ZAP_WRITE_ERROR_SECTOR_MISMATCH */
#define MSG__T440_DNTZ_UNKNOWN                200  /* Reason: Unknown */
#define MSG__T440_SERVO_CTRLR_REQ             201  /* ServoTrkFollowCtrlr change requested on unsupported servo code! */
#define MSG__T440_DCCI_SEEK_FAILED_ACFF       202  /* Seek in DCCI failed while re-enabling ACFF adaption */
#define MSG__T440_NVAS_DEBUG_0                203  /* Calling TTVTM in NVAS */
#define MSG__T440_NVAS_DEBUG_1                204  /* Calling NVAZ in NVAS */
#define MSG__T440_NVAS_DEBUG_2                205  /* Calling TTRTM in NVAS */
#define MSG__T440_FNPQ_BAD_SAMPLES            206  /* FNPQ too many bad samples */
#define MSG__T440_FNPQ_MIN_MAX                207  /* FNPQ min max too big */
#define MSG__T440_FNPQ_MEAN_MISMATCH          208  /* FNPQ mean mismatch */
#define MSG__T440_NTZSDS_RVLV                 209  /* Warning Restore RVLV in NTZSDS RVLV not disabled at restore */
#define MSG__T440_NTZWB_SERVO_MODE            210  /* NTZWB INCORRECT_SERVO_MODE not in real mode */
#define MSG__T440_NTZWB_INVALID_GAP           211  /* NTZWB NTZ_INVALID_GAP_BETWEEN_BANDS There is a gap between the previous band and this one */
#define MSG__T440_NTZWB_INVALID_WIRRO         212  /* NTZWB NTZ_ERROR_INVALID_PREVIOUS_WIRRO_DATA Previous 2 revs of Wirro is not 2 revs long */
#define MSG__T440_ANVTS_VIRTUAL_FAILED        213  /* ANVTS Failed Not in virtual mode */
#define MSG__T440_ANVTS_WARNING_VCAT          214  /* ANVTS WARNING: unexpected result from VCAT alignment */
#define MSG__ZAP_CALL_NOT_ZAPPING             215  /* The requested ZAP call does not ZAP any tracks. No Xfr func is required. */
#define MSG_T282_MAX_SCORE_FAIL               216  /* Maximum Number of entries in table P282_SENSITIVITY_OOS has been reached. */
#define MSG__MISSED_FASTIO_SAMPLES_NTZWC      217  /* NTZ Write Servo Command failed for MISSED_FASTIO_SAMPLES */
#define MSG__MALLOC_ERR_NTZDAMM               218  /* Malloc Error in NTZDataArrayMemoryManage */
#define MSG__T444_BINPERTRACK_CHNG            219  /* T444 BinPerTrack input error, change to nearest pow of 2 value */
#define MSG__T444_SAMPPERBIN_CHNG             220  /* T444 SampPerBin input error, change to nearest pow of 2 value */
#define MSG__NBDM_NOT_SUPPORTED_BY_116F       221  /* QTWOC - NBDM not supported by 116F */
#define MSG__T444_PDFPOSBINNER_SCANMIN        222  /* PdfPosBinner Error: Q12_ScanMinOffset must be negative. */
#define MSG__T444_PDFPOSBINNER_SCANMAX        223  /* PdfPosBinner Error: Q12_ScanMaxOffset must be positive. */
#define MSG__T444_PDFPOSBINNER_TRKPERREV      224  /* PdfPosBinner Error: Q12_TracksPerRev > 0x7FFF. */
#define MSG__XFR_FUNC_FROM_SPT_FILE           225  /* The transfer function will be sourced directly from the LTZXfrFunc File. */
#define MSG__SPT_XFR_RECOVERED_SUCCESSFUL     226  /* XfrFunc successfully read from the SPT results area. */
#define MSG__SPT_XFR_NOT_RECOVERED            227  /* Problem retrieving selected Xfr func from SPT Xfr file. */
#define MSG__SPT_XFR_PARMS_CONFLICT           228  /* Passed transfer function parms do not match saved parameters! */
#define MSG__SPT_XFR_FUNC_HD_ASSOC_OKAY       229  /* LgclHd association changed but PhysHd matches from inital measurement. */
#define MSG__SPT_XFR_FUNC_HD_ASSOC_FAIL       230  /* PhysHd association is incorrect, fail to resolve. */
#define MSG__SPT_XFR_FILE_PRESENT_NO_DATA     231  /* The SPTXfrFuncFile is present but has no data in it. */
#define MSG__SPT_XFR_FILE_NOT_YET_ALLOC       232  /* LTZXfrFile not yet allocated. */
#define MSG__SPT_XFR_UNPACK_TO_PCFILE_DEP     233  /* Update PF3 script to not pass Cwrd4 bit 1. Deprecated. */
#define MSG__FAST_MALLOC_FAILED               234  /* Attempt to Fast Malloc data failed */
#define MSG__REMOVE_DATA_WITH_FIT_ERRORS      235  /* Data points with residual fit errors will be removed from polynomial calculation.*/
#define MSG__MAX_FIT_ERRORS_EXCEEDED          236  /* Maximum number of residual fit errors has been exceeded.*/
#define MSG__INVALID_NUM_PHASE_NOTCHES        237  /* Invlaid number of phase notches requested */
#define MSG__MODEHOPA_ENABLED                 238  /* ModeHopA Enabled */
#define MSG__MODEHOPA_DISABLED                239  /* ModeHopA Disabled */
#define MSG__MODEHOPA_ALREADY_ENABLED         240  /* ModeHopA was found enabled prior to the command to enable ModeHopA */
#define MSG__MODEHOPA_ALREADY_DISABLED        241  /* ModeHopA was found disabled prior to the command to disable ModeHopA */
#define MSG__INVALID_FLEX_FIXUP               242  /* Cannot remove and add FLEX SMR bit from defect cyl entries in same test call. */
#define MSG__PREAMP_CONVERSION_UNSUPPORTED    243  /* Preamp converstion command not supported or failed - zeros will be returned */
#define MSG__MODE_HOP_B_ENABLED               244  /* ModeHopB Enabled */
#define MSG__MODE_HOP_B_DISABLED              245  /* ModeHopB Disabled */
#define MSG__MODE_HOP_B_ALREADY_ENABLED       246  /* ModeHopB was found enabled prior to the command to enable ModeHopB */
#define MSG__MODE_HOP_B_ALREADY_DISABLED      247  /* ModeHopB was found disabled prior to the command to disable ModeHopB */
#define MSG__LASER_APC_ENABLED                248  /* LaserAPC Enabled */
#define MSG__LASER_APC_DISABLED               249  /* LaserAPC Disabled */
#define MSG__LASER_APC_ALREADY_ENABLED        250  /* LaserAPC was found enabled prior to the command to enable LaserAPC */
#define MSG__LASER_APC_ALREADY_DISABLED       251  /* LaserAPC was found disabled prior to the command to disable LaserAPC */
#define MSG__T444_PDFPOSBINNER_OFFTRACK       252  /* PdfPosBinner Error: servo off track. */
#define MSG__NBDM_ENABLED                     253  /* NarrowBandDwellMonitor Enabled */
#define MSG__NBDM_DISABLED                    254  /* NarrowBandDwellMonitor Disabled */
#define MSG__NBDM_ALREADY_ENABLED             255  /* NarrowBandDwellMonitor was found enabled prior to the command to enable NarrowBandDwellMonitor */
#define MSG__NBDM_ALREADY_DISABLED            256  /* NarrowBandDwellMonitor was found disabled prior to the command to disable NarrowBandDwellMonitor */
#define MSG__T80_DIRECT_MEAS_UNSUPPORTED      257  /* Preamp Direct Resistance Measurement option was selected, but not supported by servo code*/
#define MSG__RV_SENSOR_DETECTED               258  /* RV Sensor detected on board */
#define MSG__RV_SENSOR_NOT_DETECTED           259  /* RV Sensor not detected on board */
#define MSG__RV_SENSOR_SYMTBL_UNSUPPORTED     260  /* RV Sensor symbol table not enabled in servo code */
#define MSG__WEDGE_DELAY_ERROR                261  /* Wedge delay error, destination sector minus start sector is zero. */
#define MSG__BODE_SPT_FILE_NOT_ALLOCATED      262  /* SPT file for Bode storage not preallocated. */
#define MSG__BODE_SPT_FILE_NOT_RECOVERED      263  /* Bode SPT file was not recovered. */
#define MSG__BODE_SPT_FILE_PRESENT_NO_DATA    264  /* The Bode SPT File is present but has no data in it. */
#define MSG__BODE_SPT_FILE_MEASUREMENT_NOT_FOUND 265 /* The Bode SPT File is present but the specified measurement is not there. */
...
#define MSG__IOTEST_SET_TABLE_27            16188  /* ---> Write  Attestation Cert table function <---*/
...
#define MSG__IOTEST_RET_MSID_CREDENTIAL     16319  /* ---> Retrieving MSID credential <---*/
#define MSG__IOTEST_PI_WRITE_NOT_SUPPORTED  16320  /* ---> PI Bytes Not written 32byte Command not supported or not PI Type 2 <---*/
#define MSG__IOTEST_DIAGKEY_MAINTKEY_VERIFICATION_PASSED 16321  /* ---> DiagKey & MaintKey verfication passed  <---*/
#define MSG__IOTEST_DIAGKEY_MAINTKEY_VERIFICATION_FAILED 16322  /* ---> DiagKey & MaintKey verfication failed  <---*/
#define MSG__IOTEST_ACTKEY_DIAGKEY_VERIFICATION_PASSED 16323  /* ---> ActKey & DiagKey verfication passed  <---*/
#define MSG__IOTEST_ACTKEY_DIAGKEY_VERIFICATION_FAILED 16324  /* ---> ActKey & DiagKey verfication failed  <---*/
#define MSG__IOTEST_ACTKEY_MAINTKEY_VERIFICATION_PASSED 16325  /* ---> ActKey & MaintKey verfication passed  <---*/
#define MSG__IOTEST_ACTKEY_MAINTKEY_VERIFICATION_FAILED 16326  /* ---> ActKey & MaintKey verfication failed  <---*/
