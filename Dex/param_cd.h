...
//
// Copyright (c) 2001 - $Date: 2022/08/18 $ Seagate Technology, LLC.
//
...
#define MIN_MAX_WRT_CUR_PARM_C                   86      // (NA,NA,NA,NA)
...
#define WC_RANGE_PARM_C                         377      // (NA,NA,NA,NA)
...
#define DATA_SET1_PARM_C                        476      // (NA,NA,NA,NA)
#define DATA_SET1_PARM_P                          4

#define DATA_SET2_PARM_C                        477      // (NA,NA,NA,NA)
#define DATA_SET2_PARM_P                          4

#define DATA_SET3_PARM_C                        478      // (NA,NA,NA,NA)
...
#define DAMPING_OFFSET_PARM_C                   587      // (DEF,PreampCldOfst_TPARCD[1],8,NA) (DEF,PreampHtOfst_TPARCD[1],8,NA)
...
#define ERRORS_TO_READ_PARM_C                   911      // (NA,NA,NA,NA)
...
#define SHOCKSENSOR_DETECT_THRESHOLD_PARM_C    1444
#define SHOCKSENSOR_DETECT_THRESHOLD_PARM_P       1

#define SHOCKSENSOR_DETECT_COUNT_PARM_C        1445
#define SHOCKSENSOR_DETECT_COUNT_PARM_P           1

#define HAMR_FIRST_SECTOR_DURATION_PARM_C      1446
#define HAMR_FIRST_SECTOR_DURATION_PARM_P         1

#define HAMR_FIRST_SECTOR_AMPLITUDE_PARM_C     1447
#define HAMR_FIRST_SECTOR_AMPLITUDE_PARM_P        1

#define RV_SENS_THRSH_PARM_C                   1448
#define RV_SENS_THRSH_PARM_P                      1

#define CYL_PAD_SEVERITY_PARM_C                1449
#define CYL_PAD_SEVERITY_PARM_P                   1

#define AFH_WH_COEFF_PARM_C                    1450
#define AFH_WH_COEFF_PARM_P                      20

#define CNVRT_DLY_PARM_C                       1451
#define CNVRT_DLY_PARM_P                          2

#define DPTH_SCAL_PARM_C                       1452
#define DPTH_SCAL_PARM_P                          1

#define PHAS_NTCH_PICK_OPTN_PARM_C             1453
#define PHAS_NTCH_PICK_OPTN_PARM_P                1
/***************************************************************************************************************************
...
#define DPO_RATIO_PARM_C                           17061
#define DPO_RATIO_PARM_P                               1

#define FUA_NV_RATIO_PARM_C                        17062
#define FUA_NV_RATIO_PARM_P                            1

#define DLD_THRESHOLD_CRITERIA_PARM_C              17063
#define DLD_THRESHOLD_CRITERIA_PARM_P                  1

#define PERFORM_CLEANUP_PARM_C                     17064
#define PERFORM_CLEANUP_PARM_P                         1

#define MAX_SUSPECT_DEFECTS_PER_DIE_PARM_C         17065
#define MAX_SUSPECT_DEFECTS_PER_DIE_PARM_P             1

#define WRITE_WITH_FF_PI_BYTES_PARM_C              17066
#define WRITE_WITH_FF_PI_BYTES_PARM_P                  1

#define UMP_ZONE_MASK_BLOCK_PARM_C                 17067
#define UMP_ZONE_MASK_BLOCK_PARM_P                    16

#define UMP_SQZ_OFFSET_PARM_C                      17068
#define UMP_SQZ_OFFSET_PARM_P                          1

#define THROTTLING_PARM_C                          17069
#define THROTTLING_PARM_P                              1

#define READ_MITIGATION_PARM_C                     17070
#define READ_MITIGATION_PARM_P                         1

#define USE_FLASH_PARM_C                           17071
#define USE_FLASH_PARM_P                               1

#define DC_DETCR2_PARM_C                           17072
#define DC_DETCR2_PARM_P                              24

#define ENABLE_ZONE_BASE_XFR_RATE_PARM_C           17073
#define ENABLE_ZONE_BASE_XFR_RATE_PARM_P               1

#define NUMBER_OF_SERPENTS_PARM_C                  17074
#define NUMBER_OF_SERPENTS_PARM_P                      1

#define ZONE_PERCENT_COVERAGE_FOR_RETRY_PARM_C     17075
#define ZONE_PERCENT_COVERAGE_FOR_RETRY_PARM_P         1

#define NUM_ADJ_SEC_WRITES_PARM_C                  17076
#define NUM_ADJ_SEC_WRITES_PARM_P                      1

#define MAX_ACTIVE_DIE_PARM_C                      17077
#define MAX_ACTIVE_DIE_PARM_P                          2

#define MIN_ACTIVE_DIE_PARM_C                      17078
#define MIN_ACTIVE_DIE_PARM_P                          2

#define LBA_ALIGNMENT_RATIO_PARM_C                 17079
#define LBA_ALIGNMENT_RATIO_PARM_P                     1

#define SENSE_DATA_HISTORY_PARM_C                  17080
#define SENSE_DATA_HISTORY_PARM_P                      1

#define DISABLE_ORDER_ERASE_PARM_C                 17081
#define DISABLE_ORDER_ERASE_PARM_P                     1

#define READ_BER_PAGE_THRESHOLD_PARM_C             17082
#define READ_BER_PAGE_THRESHOLD_PARM_P                 6

#define MAX_BER_CAT_VIOLATIONS_PARM_C              17083
#define MAX_BER_CAT_VIOLATIONS_PARM_P                  1

#define TEST_OPERATING_MODE_LUN0_PARM_C            17084
#define TEST_OPERATING_MODE_LUN0_PARM_P                1

#define TEST_OPERATING_MODE_LUN1_PARM_C            17085
#define TEST_OPERATING_MODE_LUN1_PARM_P                1

#define COMMAND_RATIO_LUN0_PARM_C                  17086
#define COMMAND_RATIO_LUN0_PARM_P                      1

#define PORT_A_SAS_DISPARITY_PARM_C                17087
#define PORT_A_SAS_DISPARITY_PARM_P                    1

#define PORT_B_SAS_DISPARITY_PARM_C                17088
#define PORT_B_SAS_DISPARITY_PARM_P                    1

#define PORT_A_INVALID_DWORD_PARM_C                17089
#define PORT_A_INVALID_DWORD_PARM_P                    1

#define PORT_B_INVALID_DWORD_PARM_C                17090
#define PORT_B_INVALID_DWORD_PARM_P                    1

#define PORT_A_LOSS_OF_SYNC_PARM_C                 17091
#define PORT_A_LOSS_OF_SYNC_PARM_P                     1

#define PORT_B_LOSS_OF_SYNC_PARM_C                 17092
#define PORT_B_LOSS_OF_SYNC_PARM_P                     1

#define PORT_A_DATA_LAYER_ERRS_PARM_C              17093
#define PORT_A_DATA_LAYER_ERRS_PARM_P                  1

#define PORT_B_DATA_LAYER_ERRS_PARM_C              17094
#define PORT_B_DATA_LAYER_ERRS_PARM_P                  1

#define SKIP_BER_DATA_PARM_C                       17095
#define SKIP_BER_DATA_PARM_P                           1

#define DIE_TEMP_POLLING_IN_SEC_PARM_C             17096
#define DIE_TEMP_POLLING_IN_SEC_PARM_P                 2

#define NUM_DUMP_LOCATIONS_PARM_C                  17097
#define NUM_DUMP_LOCATIONS_PARM_P                      1

#define BYTES_TO_NEXT_DUMP_LOC_PARM_C              17098
#define BYTES_TO_NEXT_DUMP_LOC_PARM_P                  1

#define START_LBA_LUN0_PARM_C                      17099
#define START_LBA_LUN0_PARM_P                          4

#define START_LBA_LUN1_PARM_C                      17100 
#define START_LBA_LUN1_PARM_P                          4

#define END_LBA_LUN0_PARM_C                        17101
#define END_LBA_LUN0_PARM_P                            4
                                 
#define END_LBA_LUN1_PARM_C                        17102
#define END_LBA_LUN1_PARM_P                            4

#define COMMAND_NUMBER_PARM_C                      17103
#define COMMAND_NUMBER_PARM_P                          1

#define MAX_POLL_PARM_C                            17104
#define MAX_POLL_PARM_P                                1

#define SKIP_PORT_SUPPORT_CHECK_PARM_C             17105
#define SKIP_PORT_SUPPORT_CHECK_PARM_P                 1

#define DELAY_BEFORE_ABORTED_CMD_RETRY_PARM_C      17106
#define DELAY_BEFORE_ABORTED_CMD_RETRY_PARM_P          1
...
#define STE_MAX_ERASURE_SPEC_PARM_C           32080     // (T621,SteMxEraseSpec_TPARCD,16,0x0FFF)
...
#define MAX_TIMEOUTS_PARM_C                   32271
#define MAX_TIMEOUTS_PARM_P                       1

#define DISABLE_BEST_MODE_PARM_C              32272
#define DISABLE_BEST_MODE_PARM_P                  1

#define ENBL_SC_ZN_MASK_BITS_PARM_C           32273
#define ENBL_SC_ZN_MASK_BITS_PARM_P               1

#define OD_RSV_MIN_LBA_PARM_C                 32274
#define OD_RSV_MIN_LBA_PARM_P                     4

#define OD_RSV_MAX_LBA_PARM_C                 32275
#define OD_RSV_MAX_LBA_PARM_P                     4

#define ID_RSV_MIN_LBA_PARM_C                 32276
#define ID_RSV_MIN_LBA_PARM_P                     4

#define ID_RSV_MAX_LBA_PARM_C                 32277
#define ID_RSV_MAX_LBA_PARM_P                     4

#define RAW_DATA_BLOCK_PARM_C                 32278
#define RAW_DATA_BLOCK_PARM_P                    50

#define AFH_PROFILE_COFF_PARM_C               32279
#define AFH_PROFILE_COFF_PARM_P                   15

#define PRED_ZONE_ORDER_PARM_C                32280
#define PRED_ZONE_ORDER_PARM_P                    12

#define ZONE32_PARM_C                         32281
#define ZONE32_PARM_P                             2

#define PVR_STREAM_NUM_PARM_C                 32282
#define PVR_STREAM_NUM_PARM_P                     1

#define CCT_TABLE_VALUES_PARM_C               32283
#define CCT_TABLE_VALUES_PARM_P                  60

#define BANDWIDTH32_PARM_C                    32284
#define BANDWIDTH32_PARM_P                        2

#define BANDWIDTH32_2_PARM_C                  32285
#define BANDWIDTH32_2_PARM_P                      2

#define ACTUATOR_PARM_C                       32286
#define ACTUATOR_PARM_P                           1

#define ZAC_COMMAND_TIMEOUT_MS_PARM_C         32287
#define ZAC_COMMAND_TIMEOUT_MS_PARM_P             2
