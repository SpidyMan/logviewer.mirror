...
//
// Copyright (c) 2001 - $Date: 2022/05/24 $ Seagate Technology, LLC.
//
...
*                 $Revision: #508 $
*                 $Change: 2472809 $
*                 $Author: jason.a.selby $
*                 $DateTime: 2022/05/24 11:12:36 $
********************************************************************************/
...
#define NRRO_OOS                          10358   /* Svo PES-NRRO Out of Spec */                               // SF2/3 T33, T276
...
#define RO_OOS                            10413   /* Svo PES-RO Out of Spec */                                 // T276
#define RRO_OOS                           10414   /* Svo PES-RRO Out of Spec */                                // SF2/3 T29, 33, 193, 194, T276
...
#define FAFH_TEST_SERPENTS_NOT_DEFINED    12965    /* FAFH Test Serpents are not present in format tables */   // This code needs to be redefined since it's "Check or Clear SMART failed" in Super CSS
...
#define UNSUPPORTED_PORT                  12983    /* Unsupported port */
...
#define DRIVE_IS_NOT_HA_HM_FLEX_FAIL      14061    /* Drv-Misc - Drive is not a Host Aware/Managed/Flex */
#define FLEX_CONVERSION_FAIL              14062    /* Drv-Misc - Flex Conversion Failed */
#define FMR_OR_SMR_ZONES_ARE_NOT_ONLINE   14063    /* Drv-Misc - FMR(SOBR)/SMR: Must include online(active) areas */
#define READ_REQUEST_AND_ZONES_ARE_EMPTY  14064    /* Drv-Misc - Cannot read in empty zones */
#define WRITE_REQUEST_AND_WP_MISMATCH     14065    /* Drv-Misc - Cannot write in requested location */
#define HARD_RESET_FAILED_SIGNATURE       14066    /* Drv Misc - Hard Reset Signature missing */
#define FAILED_TIME_TO_READY_SIGNATURE    14067    /* Drv Misc - Drive Signature not received */
...
#define FREQ_PLL_CALCULATION_FAILURE      15010    /* FAFH frequency PLL calculation failure */
#define SDW_WRITER_VERIFICATION_FAILED    15011    /* SDW Test failed. Written track not found */
#define R2R_GAP_CAL_ERR_STATUS_FAILURE    15012    /* Reader-to-reader channel calibration failed due to a bad ADC error status number */
#define R2R_SEPARATION_CAL_FAILURE        15013    /* Reader-to-reader channel calibration did not meet passing criteria */
#define R2R_GAP_DELAY_VALUES_EXCEEDED_LIMIT  15014    /* R2R gap delay number exceeded limit */
...
#define SCOPY_TWIST_SEEK_FAIL                       30001    /* Scopy TWIST seek failed. */
...
#define RCTRKID_DELTA_LIMIT_EXCEEDED                48936    /* RampCyl Delta Limit Exceeded */
...
#define INCOMPATIBLE_MATRIX_DIMENSIONS              48961    /* Incompatible Matrix Dimensions */
...
#define POLY_CAP_FAILURE                            49155    /* Potential Poly Cap Failure */
#define READER_SELECT_FAILED                        49156    /* ReaderSelect Failure - Failed to Update Rap Reader*/
#define MFG_AREA_NOT_INITIALIZED                    49157    /* Manufacturing flash area not initialized */
...
#define EXCEEDED_MAX_MR_BIAS                        49200    /* Exceeded maximum allowed MR reader bias */
#define EXCEEDED_MAX_MR_GAIN                        49201    /* Exceeded maximum allowed MR reader gain */
#define EXCEEDED_MAX_MR_RANGE                       49202    /* Exceeded maximum allowed MR reader range */
#define FUNCTION_PARAMETER_ERROR                    49203    /* Runtime function input parameter error */
#define BAD_SERVO_COMMAND_DIAGNOSTIC_STATUS         49206    /* Servo command bad diagnostic status */
#define SUSPECT_LIST_LIMIT_EXCEEDED                 49212    /* Suspect List Limit Exceeded */
#define SSD_HW_INIT_FAILED                          49214    /* POFMMCS HW Init Failed */
#define SSD_CHANNEL_INIT_FAILED                     49215    /* POFMMCS Channel/Flash Init Failed */
#define ROLL_OVER_DAC_BELOW_MAX_DAC                 49216    /* AFH RolloOver Dac below MAX_DAC*/
#define PREAMP_BIAS_UPDATE_FAILED                   49218    /* Failed to update preamp MR reader bias */
#define PREAMP_GAIN_UPDATE_FAILED                   49219    /* Failed to update preamp MR reader gain */
#define MAX_BIT_PHASE_SHIFT_PERCENT_EXCEEDED        49221    /* Max bit phase shift percent exceeded */
#define MAX_SCRATCH_DEFECTS_EXCEEDED                49231    /* T118 max scratch defects exceeded */
#define BAND_RESONANCE_LIMIT_EXCEEDED               49242    /* Band Resonance Limit Exceeded */
#define DIE_UNIQUE_ID_MISMATCH                      49247    /* Die Unqiue ID comparison failure */
#define NTZ_FAIL_POSTRRO                            49250    /* NTZ post-RRO worse than pre-RRO */
#define NTZ_INSUFFICIENT_NATIVE_TRACKS_AT_ID        49252    /* Not enough tracks at ID for DT overshoot plus cals */
#define HOST_RETURNED_LESS_BYTES_THAN_EXPECTED      49257    /* Host returned less bytes than expected */
#define HOST_RETURNED_UNEXPECTED_XFER_TYPE          49258    /* Host returned unexpected xfer type */
#define HOST_RETURNED_UNEXPECTED_BLOCK_NUMBER       49259    /* Host returned unexpected block number */
#define QNR_RDL_FIRMWARE_CHECK_FAILED               49263    /* QNR/RDL firmware check failure */
#define SCOPY_SPIRAL_PATTERN_WRITE_FAILED           49266    /* Report error in spiral writing step */
#define SCOPY_SPIRAL_PATTERN_ERASE_FAILED           49267    /* Spiral pattern erase failed */

#define DRIVE_OFF_12V_OVER_VOLTAGE                  49275    /* DriveOff 12V Over-voltage */
#define DRIVE_OFF_5V_OVER_VOLTAGE                   49278    /* DriveOff 5V Over-voltage */
#define VGAS_MEASUREMENT_RAILED_HIGH                49279    /* VGAS Railed High */
#define VGAS_MEASUREMENT_RAILED_LOW                 49280    /* VGAS Railed Low */
#define NO_VALID_VGAS_MEASUREMENTS                  49281    /* No valid VGAS measurements */
#define NO_VALID_GAIN_ATTN_FOR_TARGET_VOLTAGE       49282    /* No valid gain/atten for target voltage */
#define MIN_NTZ_BATHTUB_ERROR_RATE_TOO_HIGH         49286    /* Minimum NTZ error rate too high */
#define SHALLOW_ERASE_FAILURE                       49295    /* Failed to set flash shallow erase */
#define SATA_SCT_RPC_STATUS_ERROR                   49297    /* SATA SCT RPC Status Error */
#define SATA_SCT_RPC_BAD_BYTE_COUNT                 49298    /* SATA SCT RPC Bad Byte Count */
#define LIN_MAX_POS_ERROR_EXCEEDED                  49300    /* Servo Lin - Max position error exceeded */
#define DCT_UPDATE_FAILED                           49301    /* Failed to populate drive config table */
#define MAX_CRRO_AT_ID_LIMIT_EXCEEDED               49302    /* Max CRRO at ID limit exceeded */
#define CRRO_HARM_AT_ID_LIMIT_EXCEEDED              49303    /* CRRO Harmonic at ID limit exceeded */
#define TOO_FEW_AFH_FRAMES_FOR_PROCESS_STATE        49304    /* Too few AFH frames for process state */
#define TOO_MANY_BAD_LINEARIZED_POSITION_SAMPLES    49306    /* Too many bad linearized position samples */
#define MCT_SEND_PASS_SYNC_FAIL                     49308    /* Dual Actuator - Sending Pass Sync Failure */
#define MCT_SEND_FAIL_SYNC_FAIL                     49309    /* Dual Actuator - Sending Fail Sync Failure */
#define MCT_RESPONSE_SYNC_FAIL                      49310    /* Dual Actuator - Sending Response Sync Failure */
#define MCT_ON_SLAVE_ONLY_NOT_SUPPORTED             49311    /* Dual Actuator - Illegal MCT download to slave processor (keeping the old naming to avoid break on other branches) */
#define MCT_ON_AUXILIARY_ONLY_NOT_SUPPORTED         49311    /* Dual Actuator - Illegal MCT download to slave processor */
#define EXCEEDED_SERVO_DRAM_BLOCK_ID_LIMIT          49314    /* Servo DRAM Block ID Limit Exceeded */
#define UNSUPPORTED_SERVO_DRAM_BLOCK_ID             49315    /* Unsupported Servo DRAM Block ID */
#define LFA_BER_MEAN_LIMIT_EXCEEDED                 49319    /* LFA Ber Mean exceeds limit */
#define LFA_BER_STDEV_LIMIT_EXCEEDED                49320    /* LFA Ber STDev exceeds limit */
#define LFA_BER_FIANL_ITER_LIMIT_EXCEEDED           49322    /* LFA final iteration BER exceeds limit */
#define HAMR_SYSTEM_FILE_INIT_FAILURE               49323    /* Error initializing the HAMR sys file */
#define ERROR_SETTING_PREAMP_PARAMETER              49324    /* Error setting a preamp parameter */
#define LFA_TOO_MANY_FAILED_ITERATIONS              49325    /* Too many failed LFA iterations */
#define LFA_ZERO_SUCCESSFUL_ITERATIONS              49326    /* No successful LFA iterations */
#define LFA_INVALID_IOP_RESULT_SELECT               49327    /* Invalid LFA IOP result select */
#define ERROR_WRITING_HAMR_SYSTEM_FILE_TO_DISC      49328    /* Error writing HAMR sys file to disc */
#define LFA_IOP_MEAN_LIMIT_EXCEEDED                 49329    /* LFA IOP Mean exceeds limit */
#define LFA_IOP_MEDIAN_LIMIT_EXCEEDED               49330    /* LFA IOP Median exceeds limit */
#define LFA_IOP_STDEV_LIMIT_EXCEEDED                49331    /* LFA IOP STDev exceeds limit */
#define LFA_IOP_FINAL_ITER_LIMIT_EXCEEDED           49332    /* LFA final iteration IOP exceeds limit */
#define UNCOMPRESSED_FLASH_SECTION_TOO_LARGE        49334    /* Uncompressed flash segment too large */
#define FAILED_TO_DECOMPRESS_FLASH_SECTION          49336    /* Failed to decompress flash section */
#define INVALID_IOP_STARTING_SELECTION              49337    /* Invalid starting IOP selection */
#define HAMR_SYSTEM_FILE_NOT_LOADED                 49339    /* HAMR system file not loaded */
#define NO_PREVIOUS_LFA_RESULTS                     49340    /* No previous LFA results */
#define INVALID_RAP_ENTRY_FOUND                     49341    /* Invalid RAP entry found */
#define WAIT_SERVO_EVENT_FLAGST_TIMEOUT             49345    /* Wait for servo event flags timeout */
#define WAIT_SERVO_EVENT_FLAGS_ABORTED              49346    /* Wait for servo event flags aborted */
#define SENSITIVITY_FREQ_LIMIT_ERR_CODE_REG_0       49352    /* Sensitivity OOS Frequency limit error reg 0 */
#define SENSITIVITY_FREQ_LIMIT_ERR_CODE_REG_1       49353    /* Sensitivity OOS Frequency limit error reg 1 */
#define SENSITIVITY_FREQ_LIMIT_ERR_CODE_REG_2       49354    /* Sensitivity OOS Frequency limit error reg 2 */
#define SENSITIVITY_FREQ_LIMIT_ERR_CODE_REG_3       49355    /* Sensitivity OOS Frequency limit error reg 3 */
#define SENSITIVITY_FREQ_LIMIT_ERR_CODE_REG_4       49356    /* Sensitivity OOS Frequency limit error reg 4 */
#define SCOPY_SEED_SAP_DATA_FAULTS                  49358    /* Seed Scopy data corrupted */
#define CLEARANCE_SWEEP_NEGATIVE                    49364    /* Clrnc sweep strt or end less than 0 */
#define CLEARANCE_SWEEP_ZERO_STEP                   49365    /* Step equal to 0 for non zero range */
#define CLEARANCE_SWEEP_STEP_WRONG_DIRECTION        49366    /* Step not towards end of range */
#define SERVO_CMD_XX6F_NOT_SUPPORTED                49370    /* Servo command XX6F not supported */
#define UNEXPECTED_SERVO_COMMAND_DATA_RESPONSE      49372    /* Unexpected servo command data response */
#define FAILED_PROGRAM_SUSPEND_CHECK                49374    /* Failed to see program suspend on all die */
#define SCOPY_HIGH_SRVO_TMR_FAULTS                  49500    /* SCopy High Srvo - TMR Faults */
#define HAMR_LASER_THRESHOLD_CAL_FAILED             49375    /* HAMR Laser Threshold Calibration Failed */
#define PROG_ERASE_SUSPEND_FAILURE                  54802    /* Nand program erase suspend failure */
#define PROGRAM_SUSPEND_FAILURE                     54804    /* Program suspend flash failure */
#define ERASE_SUSPEND_FAILURE                       54805    /* Erase suspend flash failure */
#define AFH_FRAMES_FILE_MAJOR_REV_MISMATCH          54807    /* AFH frames file major revision mismatch */
#define AFH_FRAMES_FILE_MINOR_REV_MISMATCH          54808    /* AFH frames file minor revision mismatch */
#define AFH_FRAMES_FILE_MAX_NUM_FRAMES_EXCEEDED     54809    /* AFH frames file max num frames exceeded */
#define AFH_FRAMES_FILE_CONTAINS_ZERO_FRAMES        54810    /* AFH frames file contains zero frames */
#define AFH_FRAMES_FILE_FRAME_SIZE_MISMATCH         54811    /* AFH frames file frame size mismatch */
#define IPC_SYNCHRONIZATION_FAILURE                 54815    /* IPC synchronization failure */
#define SCOPY_UNINITIALIZED_AFH_ZONE_TABLE          54817    /* SCopy - Exp. Values Not Found in AFH Table */
#define SERVO_UNRECOVERED_SEEK_FAILURE              54818    /* Servo unrecovered seek failure */
#define BAD_BLOCK_ON_DEFECT_LIST                    54821    /* Bad block found on the defect list */
#define BODE_FILE_READ_FAILED                       54823    /* Unable to read full spectrum bode file */
#define CHANNEL_REGISTER_WRITE_FAILED               54825    /* Failed to write channel register */
#define POLY_FIT_OUTLIER_MAXIMUM_EXCEEDED           54937    /* Maximum number of polyfit outliers exceeded */
#define MOTOR_AWAKE0_FAULT_LC_DETECTED              54942    /* Motor Awake Fault 0 Post Seek */
#define SERVO_PATTERN_MISSING                       54945    /* Servo Pattern Missing */
#define MAX_FIT_DEVIATION_EXCEEDED                  54947    /* Maximum fit deviation exceeded */
#define INVALID_FREQUENCY_RANGE_DETECTED            54950    /* Invalid Frequency Range */
#define MISSING_DATA                                54951    /* Data is missing from a required step */
#define SCOPY_SET_VCAT_FOR_J2S_FAILED               54963    /* Set servo copy vcat j2s failed */
#define UNRECOV_READ_SUSPEND_FAILURE                54965    /* Unrecoverable read suspend flash failure */
#define SVO_LLP_UNSAFE_FAULT                        54966    /* Svo LLP Unsafe Fault Encountered */
#define PRINT_FORMAT_ENCODING_ERROR                 54968    /* Print format encoding error */
#define INVALID_NUMBER_OF_PHASE_NOTCHES             54972    /* Invalid num of phase notches specified */
#define DIAG_COMMAND_FAILED                         55020    /* Diag command failed */
#define CHANNEL_BCI_LOG_OVERFLOW                    55021    /* Channel BCI log overflow */
#define CHANNEL_BCI_FIFO_OVERFLOW                   55022    /* Channel BCI FIFO overflow */
#define BCI_DATA_COLLECTION_FAILED                  55023    /* Channel BCI data collection failed */
#define UNEXPECTED_INFINITE_FLOAT                   55024    /* Unexpected infinite float */
#define UNEXPECTED_NAN_FLOAT                        55025    /* Unexpected NAN float */
#define TOO_FEW_GOOD_BCI_SAMPLES                    55026    /* Too few good BCI samples for BER calc. */
#define FAILED_TO_CONVERGE                          55027    /* Failed to converge on a single solution */
#define CLEARANCE_CHANGED_BETWEEN_MEASUREMENTS      55028    /* Clearance changed between measurements */
#define MAX_CLEARANCE_FAILURE                       55029    /* Failed max clearance limit */
#define LASER_BIAS_CHANGED_BETWEEN_MEASUREMENTS     55032    /* Laser bias changed between measurements */
#define LASER_OP_CHANGED_BETWEEN_MEASUREMENTS       55033    /* Laser op changed between measurements */
#define LASER_RES_CHANGED_BETWEEN_MEASUREMENTS      55034    /* Laser res changed between measurements */
#define BCI_DATA_BUFFER_LENGTH_MISMATCH             55035    /* BCI data buffer length mismatch */
#define UNABLE_TO_PLACE_ADN_FILTER                  55036    /* Unable to place ADN filter */
#define SCOPY_HEAD_HEALTH_CHECK_FAILED              55124    /* Head degradation detected during SCopy */
#define ZERO_HEAT_AT_NEGATIVE_CLEARANCE             55129    /* Zero heat at negative clearance */
#define NO_VALID_DBER_DATA                          55138    /* No valid delta BER cal data */
#define RETRIES_EXHAUSTED                           55139    /* Consumed all available retries */
#define WATCHDOG_TIMEOUT                            55140    /* Watchdog timer prevented infinite loop */
#define DETCR_FEATURE_SYSTEM_UNINITIALIZED          55146    /* DETCR feature system uninitialized */
#define DETCR_FEATURE_SYSTEM_ILLEGAL_STATE          55147    /* DETCR feature system illegal state */
#define DETCR_FEATURE_UNSUPPORTED                   55148    /* Requested DETCR feature is unsupported */
#define UNSUPPORTED_SEEK_LIST_FILE_VERSION          55163    /* Unsupported seek list file version */
#define APC_DC_CANCEL_CAL_FAILURE                   55273    /* APC DC Cancel Calibration Failure */
#define TOO_FEW_POINTS_4_FINAL_FIT_LASER            55285    /* Too Few Data Points for Final Fit during IOP calibration T418 */
#define TOO_FEW_POINTS_4_FINAL_FIT_PJOG             55286    /* Too Few Data Points for Final Fit during Predict jog table T418 */
#define TOO_FEW_POINTS_4_FINAL_FIT_DTTG             55287    /* Too Few Data Points for Final Fit during DTTG T012 */
#define MIN_CLEARANCE_FAILURE_T418                  55292    /* DRV Head - Failed Min Clearance Limit during laser calibration */
#define MIN_CLEARANCE_FAILURE_T443                  55294    /* DRV Head - Failed Min Clearance Limit during Default Prewrite Clearance Offset*/
#define P135_TEMP_RANGE_EXCEEDED                    55298    /* T135 Temperature Range Limit Exceeded */
#define INVALID_APC_TARGET_BOLO                     55309    /* Invalid APC target bolo */
#define INVALID_APC_TARGET_BOLO_SLOPE               55310    /* Invalid APC target bolo slope */
#define INVALID_APC_DC_CANCEL                       55311    /* Invalid APC DC Cancel */
#define INVALID_APC_BOLO_VS_DC_CANCEL_SLOPE         55312    /* Invalid APC Bolo Vs DC Cancel Slope */
#define TOO_FEW_SAMPLES_FOR_CALCULATION             55317    /* Too few samples for calculation */
#define CURVE_FIT_RMSE_LIMIT_EXCEEDED               55318    /* Curve fit RMSE limit exceeded */
#define NULL_SENSITIVITY_TOO_NARROW                 55354    /* Null sensitivity too narrow */
#define FAFH_TEST_TRACKS_NOT_DEFINED                55363    /* FAFH Test Tracks cannot be defined or are not defined */
#define TOO_MANY_FAILED_MEASUREMENTS                55378    /* Too Many Failed Measurements */
#define T284_SCOPY_ERROR                            55382    /* Test 284 SCOPY error */
#define INCORRECT_SYSTEM_FILE                       55420    /* Incorrect system file */
#define BODE_MEASUREMENT_NOT_IN_FILE                55432    /* Requested measurement not in SPT file */
#define POWER_TELEMETRY_UNSUPPORTED_BY_HW           55452    /* Hardware doesn't support Power Telemetry */
#define INCORRECT_HEAD_RANGE                        55456    /* Invalid head range */
#define SECURITY_SIGNATURE_FAIL                     55528    /* Security signature validation failure */
#define SIGNATURE_ALG_INVALID                       55530    /* Signature algorithm not found */
#define DNLD_CHKSUM_FAIL                            55531    /* Download checksum firmware failed */
#define SECURITY_HEADER_INFO_INVALID                55532    /* Security header info value invalid */
#define ENVIRONMENTAL_SENSOR_INVALID_DATA           55536    /* Environmental Sensor had Invalid Data */
#define ENVIRONMENTAL_SENSOR_MEASURMENT_FAILED      55537    /* Environmental Sensor Meas Failed */
#define TEMPERATURE_OUT_OF_FW_BOUNDS                55538    /* Temperature Out of FW Bounds */
#define PRESSURE_OUT_OF_FW_BOUNDS                   55539    /* Pressure Out of FW Bounds */
#define HUMIDITY_OUT_OF_FW_BOUNDS                   55540    /* Humidity Out of FW Bounds */
#define SSS_GAIN_MARGIN_FAILED                      55620    /* Single stage Sens Gain Margin Failed */
#define CSEFW_DETECTED_SIGNATURE_TYPE_MISMATCH      55627    /* CSEFW Detected Signature Type Mismatch */
#define IFUSE_XFER_FUNC_COEFFS_OUT_OF_RANGE         55631    /* Ifuse xfer func coeffs out of range */
#define TOO_FEW_VALID_MEASUREMENTS                  55632    /* Too few valid measurements */
